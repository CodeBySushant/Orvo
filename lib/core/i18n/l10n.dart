...
class L10n {
  ...
  String get duplicateFinder => _s(['Duplicate finder', 'डुप्लीकेट खोजें', 'Buscar duplicados', '重複ファイル検索', '중복 곡 찾기', 'Duplikate finden', 'Recherche de doublons', 'Поиск дубликатов']);
  String get duplicateFinderSub => _s(['Find and remove duplicate copies of songs', 'गानों की डुप्लीकेट कॉपियाँ ढूँढें और हटाएँ', 'Encuentra y elimina copias duplicadas', '曲の重複コピーを検索して削除', '중복된 곡 사본을 찾아 삭제', 'Doppelte Songkopien finden und entfernen', 'Trouver et supprimer les copies en double', 'Найти и удалить дубликаты песен']);
  // FEATURE (backup): backup & restore.
  String get backupRestore => _s(['Backup & Restore', 'बैकअप और रीस्टोर', 'Copia y restauración', 'バックアップと復元', '백업 및 복원', 'Sichern & Wiederherstellen', 'Sauvegarde et restauration', 'Резервное копирование']);
  String get backupRestoreSub => _s(['Save playlists, favorites & settings to Google Drive or a file', 'प्लेलिस्ट, पसंदीदा और सेटिंग्स Google Drive या फ़ाइल में सहेजें', 'Guarda playlists, favoritos y ajustes en Google Drive o un archivo', 'プレイリスト・お気に入り・設定をGoogle Driveやファイルに保存', '재생목록·즐겨찾기·설정을 Google Drive나 파일로 저장', 'Playlists, Favoriten & Einstellungen in Google Drive oder einer Datei sichern', 'Enregistrer playlists, favoris et réglages sur Google Drive ou un fichier', 'Сохранить плейлисты, избранное и настройки в Google Drive или файл']);
